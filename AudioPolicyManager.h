...
protected:
        ...
        sp<AudioPatch> createTelephonyPatch(bool isRx, const sp<DeviceDescriptor> &device,
                                            uint32_t delayMs);
    void dumpTelephonyPatches() const;
        ...
        void releaseTelephonyPatch(bool isRx, const char *reason = nullptr);
        bool isTelephonyPatchActive(bool isRx,
        ...
        audio_port_handle_t mCallTxDeviceId = AUDIO_PORT_HANDLE_NONE;
        audio_port_handle_t mCallRxDeviceId = AUDIO_PORT_HANDLE_NONE;
        bool mCallRoutingInProgress = false;
        ...
        audio_port_handle_t mSimcomVoicePortId;
